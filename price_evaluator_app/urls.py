"""price_evaluator_app URL Configuration
...
urlpatterns = [
    ...
    path('projects/add-new-project/<int:pk>/', AddProductsToProject.as_view(), name='products_to_project'),
    path('projects/<int:project_id>/', ProjectDetails.as_view(), name='project'),
]
